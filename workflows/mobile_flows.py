...
class MobileFlows():
    ...
    @staticmethod
    @allure.step("fill in the mortgage flow")
    def mortgage_flow(amount, term, rate, save):
        Mobile_Actions.input_text(page.mobile_calculator.get_amount(), amount)
        Mobile_Actions.input_text(page.mobile_calculator.get_term(), term)
        Mobile_Actions.input_text(page.mobile_calculator.get_rate(), rate)
